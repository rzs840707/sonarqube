...
public class WebhookQGChangeEventListenerTest {
  ...
  public void onChanges_has_no_effect_if_no_webhook_is_configured() {
    ...
    mockedUnderTest.onChanges(Trigger.ISSUE_CHANGE, ImmutableList.of(
      new QGChangeEvent(new BranchDto(), new ComponentDto(), new SnapshotDto(), configuration1),
      new QGChangeEvent(new BranchDto(), new ComponentDto(), new SnapshotDto(), configuration2)));
    ...
    assertThat(projectAnalysis).isEqualTo(
      new ProjectAnalysis(
        ...
        new QualityGate(
          ...
          ImmutableSet.of(
            new QualityGate.Condition(QualityGate.EvaluationStatus.OK, BUGS_KEY, GREATER_THAN, "0", null, false, "0"),
            new QualityGate.Condition(QualityGate.EvaluationStatus.OK, VULNERABILITIES_KEY, GREATER_THAN, "0", null, false, "0"),
            new QualityGate.Condition(QualityGate.EvaluationStatus.OK, CODE_SMELLS_KEY, GREATER_THAN, "0", null, false, "0"))),
        null,
        properties));
  }
  ...
  public void compute_QG_ok_if_there_is_no_issue_in_index_ignoring_permissions() {
    ...
    assertThat(qualityGate.getConditions())
      ...
      .containsOnly(tuple(QualityGate.EvaluationStatus.OK, Optional.of("0")));
  }
  ...
  public void computes_QG_error_if_there_is_one_unresolved_bug_issue_in_index_ignoring_permissions() {
    ...
    computesQGErrorIfThereIsAtLeastOneUnresolvedIssueInIndexOfTypeIgnoringPermissions(
      unresolvedIssues,
      RuleType.BUG,
      tuple(BUGS_KEY, QualityGate.EvaluationStatus.ERROR, Optional.of(valueOf(unresolvedIssues))),
      tuple(VULNERABILITIES_KEY, QualityGate.EvaluationStatus.OK, Optional.of("0")),
      tuple(CODE_SMELLS_KEY, QualityGate.EvaluationStatus.OK, Optional.of("0")));
  }
  ...
  public void computes_QG_error_if_there_is_one_unresolved_vulnerability_issue_in_index_ignoring_permissions() {
    ...
    computesQGErrorIfThereIsAtLeastOneUnresolvedIssueInIndexOfTypeIgnoringPermissions(
      ...
      tuple(BUGS_KEY, QualityGate.EvaluationStatus.OK, Optional.of("0")),
      tuple(VULNERABILITIES_KEY, QualityGate.EvaluationStatus.ERROR, Optional.of(valueOf(unresolvedIssues))),
      tuple(CODE_SMELLS_KEY, QualityGate.EvaluationStatus.OK, Optional.of("0")));
  }
  ...
  public void computes_QG_error_if_there_is_one_unresolved_codeSmell_issue_in_index_ignoring_permissions() {
    ...
    computesQGErrorIfThereIsAtLeastOneUnresolvedIssueInIndexOfTypeIgnoringPermissions(
      ...
      tuple(BUGS_KEY, QualityGate.EvaluationStatus.OK, Optional.of("0")),
      tuple(VULNERABILITIES_KEY, QualityGate.EvaluationStatus.OK, Optional.of("0")),
      tuple(CODE_SMELLS_KEY, QualityGate.EvaluationStatus.ERROR, Optional.of(valueOf(unresolvedIssues))));
  }
  ...
  public void computes_QG_error_with_all_failing_conditions() {
    ...
    assertThat(qualityGate.getConditions())
      .extracting(QualityGate.Condition::getMetricKey, QualityGate.Condition::getStatus, QualityGate.Condition::getValue)
      .containsOnly(
        Tuple.tuple(BUGS_KEY, QualityGate.EvaluationStatus.ERROR, Optional.of(valueOf(unresolvedBugs))),
        Tuple.tuple(VULNERABILITIES_KEY, QualityGate.EvaluationStatus.ERROR, Optional.of(valueOf(unresolvedVulnerabilities))),
        Tuple.tuple(CODE_SMELLS_KEY, QualityGate.EvaluationStatus.ERROR, Optional.of(valueOf(unresolvedCodeSmells))));
  }
  ...
  private static QGChangeEvent newQGChangeEvent(ComponentAndBranch branch, SnapshotDto analysis, Configuration configuration) {
    return new QGChangeEvent(branch.branch, branch.component, analysis, configuration);
  }
